...
class NavigationStack<ItemIdentifier: Equatable>: ObservableObject {
    ...
    init(initialIdentifier: ItemIdentifier){
        ...
        navigationItemAppearedSubject = PassthroughSubject()
        
        navigationItemAppearedSubscription = navigationItemAppearedSubject.scan((nil, initialIdentifier), { prev, next in
            (prev.1, next)
